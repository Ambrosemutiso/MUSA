        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="w-full md:w-2/4 mb-6 md:mb-0">
            <ul className="flex flex-wrap justify-center space-x-8">
              <li><Link to='/admin' className="hover:text-gray-400">Home</Link></li>
              <li><Link to='/admin' className="hover:text-gray-400">About</Link></li>
              <li><Link to='/admin' className="hover:text-gray-400">Services</Link></li>
              <li><Link to='/admin' className="hover:text-gray-400">Contact</Link></li>
              <li><Link to='/admin' className="hover:text-gray-400">Terms of Service</Link></li>
            </ul>
          </div>
